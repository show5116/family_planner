...
| 영역 | 설명 |
|---|---|
| **✨ AI 시황 브리핑** | 그날 시장을 요약한 카드 세 장 (아래에서 자세히) |
...
목록 맨 위에 **AI 시황 브리핑** 카드가 나옵니다. 그날 시장을 세 갈래로 요약해 줍니다.
...
접혀 있을 때는 한 줄 제목만 보입니다. **카드를 누르면 펼쳐집니다.**

![AI 시황 브리핑 펼친 화면](screenshots/02-ai-briefing.png)
*브리핑 카드를 누르면 펼쳐져 본문과 갱신 시각이 나옵니다*

지수 등락뿐 아니라 **왜 그렇게 움직였는지**까지 문장으로 정리해 줍니다.
"코스피는 15.98포인트 하락… 외국인과 기관이 대형주를 일부 매도하면서" 처럼요.
환율·국고채 금리 같은 관련 지표도 함께 짚어줍니다.

본문 맨 아래에 `업데이트: 9/9 07:30` 형태로 **언제 만들어진 브리핑인지** 나옵니다.
카드를 다시 누르면 접힙니다.
...
![전체 지표 목록](screenshots/03-all.png)
...
![지표 상세](screenshots/04-detail.png)
*지표 상세 — 현재가와 시세 추이*
...
![1년 차트](screenshots/05-chart-1y.png)
...
![금 국내 이격률](screenshots/06-spread.png)
*금 (국내) — 국제 환산가 대비 이격률*
...
![이격률 추이 차트](screenshots/07-spread-chart.png)
