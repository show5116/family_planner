...
class GroupDialogs {
  ...
  static Future<void> showRegenerateCodeDialog(
    ...
    if (confirmed == true && context.mounted) {
      try {
        await ref.read(groupNotifierProvider.notifier).regenerateInviteCode(groupId);
        if (context.mounted) {
  ...
  /// 멤버 초대 다이얼로그
  static void showInviteMemberDialog(BuildContext context, AppLocalizations l10n) {
