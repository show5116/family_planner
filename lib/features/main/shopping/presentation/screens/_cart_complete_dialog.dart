...
class _TransferDetail {
  ...
  _TransferDetail({required this.cartItem, required this.storageId})
          ...
          ? _details
                .map(
                  (d) => TransferItemDto(
                    ...
                    quantity:
                        int.tryParse(d.quantity.text) ?? d.cartItem.quantity,
...
class _Step1Content extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        Text(
          l10n.fridge_cart_complete_transfer_hint,
...
class _Step2ContentState extends ConsumerState<_Step2Content> {
  ...
  void _matchAll(List<ExpiryPresetModel> presets, List<StorageModel> storages) {
    ...
    for (final d in widget.details) {
      ...
      if (storageType != null) {
        match = best(
          presets.where((p) => p.storageType == storageType && hits(p)),
        );
      }
                ...
                firstChild: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  _openReferenceSelector(d, storages),
                            ),
                            const Icon(Icons.calendar_today_outlined, size: 18),
                          ],
                        ),
                      ...
                      if (d.expiresAt == null &&
                          _suggestions[d.cartItem.id] != null)
                        _SuggestionChip(
                      ...
                      if (d.expiresAt != null)
                        Row(
                          children: [
                            Text(
                              l10n.fridge_item_alert_days(d.alertDays),
          ...
          if (!excluded)
            FocusDismissDropdown(
              child: DropdownButton<String?>(
                ...
                hint: Text(
                  l10n.fridge_cart_skip_transfer,
...
final _shoppingMerchantsProvider = FutureProvider.autoDispose
    .family<List<MerchantModel>, String>(
      (ref, groupId) =>
      ...
      data: (merchants) => InputDecorator(
        ...
        child: FocusDismissDropdown(
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String?>(
              value: merchants.any((m) => m.id == selectedId)
                  ? selectedId
                  : null,
              isExpanded: true,
              isDense: true,
