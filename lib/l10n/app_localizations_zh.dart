...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get household_revenue => '收入';
  ...
  @override
  String get household_recurring_expense_total => '支出合计';

  @override
  String get household_recurring_income_total => '收入合计';

  @override
  String household_unpaid_recurring_expense(int count, String amount) {
    return '支出$count笔 · ₩$amount';
  }

  @override
  String household_unpaid_recurring_income(int count, String amount) {
    return '收入$count笔 · ₩$amount';
  }
  ...
  @override
  String get household_recurring_amount_variable_label => '基准金额（预估）';

  @override
  String get household_recurring_amount_variable_hint =>
      '每月金额可能不同，实际支出后请修改并确认。';

  @override
  String get household_recurring_amount_fixed_hint => '每月将自动以此金额登记。';
  ...
  @override
  String get household_recurring_title => '固定明细';

  @override
  String get household_recurring_add_title => '添加固定明细';

  @override
  String get household_recurring_edit_title => '编辑固定明细';

  @override
  String get household_recurring_day_of_month => '每月发生日';
  ...
  @override
  String get household_unpaid_recurring_title => '本月剩余固定明细';
  ...
  @override
  String get diary_quota_monthly => '本月上传';

  @override
  String get diary_quota_total => '存储空间';
  ...
  @override
  String get diary_quota_monthly_note => '删除照片会立即释放存储空间，但本月的上传额度仍保持已用状态。';

  @override
  String get diary_quota_upgrade => '增加容量';

  @override
  String get diary_quota_exceeded_title => '本月免费额度已用完';

  @override
  String get diary_quota_total_exceeded_title => '存储空间不足';

  @override
  String get diary_quota_exceeded_options => '下个月会重置，或者整理存储空间后可以继续上传。';

  @override
  String get diary_file_too_large => '文件太大了';

  @override
  String get diary_file_too_large_hint => '压缩后可以大幅减小体积。';

  @override
  String get diary_video_not_allowed => '视频附件可在更高级套餐中使用';

  @override
  String get diary_add_photo => '添加照片';
  ...
  @override
  String get diary_upload_compressed => '压缩后上传';

  @override
  String get diary_upload_original => '上传原图';

  @override
  String diary_upload_saved(String before, String after, int percent) {
    return '$before → $after（节省$percent%）';
  }

  @override
  String get diary_upload_start => '上传';

  @override
  String get diary_upload_failed => '上传失败';

  @override
  String get diary_upload_retry => '重试';

  @override
  String get diary_media_delete_confirm => '要删除这张照片吗？';

  @override
  String get diary_media_delete_permanent => '照片和视频会立即删除，无法恢复。';

  @override
  String get diary_storage_manage => '管理存储空间';

  @override
  String get diary_storage_large_files => '占用较大的项目';

  @override
  String get diary_storage_only_original => '仅原图';

  @override
  String get diary_storage_empty => '没有需要整理的项目';
